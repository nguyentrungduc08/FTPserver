...
${OBJECTDIR}/Resources/CoreServer.o: Resources/CoreServer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Resources/CoreServer.o Resources/CoreServer.cpp
...
${OBJECTDIR}/Resources/serverconnection.o: Resources/serverconnection.cpp
	${MKDIR} -p ${OBJECTDIR}/Resources
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Resources/serverconnection.o Resources/serverconnection.cpp

${OBJECTDIR}/Resources/socket.o: Resources/socket.cpp
	${MKDIR} -p ${OBJECTDIR}/Resources
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Resources/socket.o Resources/socket.cpp
